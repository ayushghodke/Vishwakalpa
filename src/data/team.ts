...
export const team: TeamMember[] = [
    {
        ...
        role: 'Co-Founder and Principal Advisor',
    ...
    },
    {
        ...
        credential: 'Licensed Structural Design Engineer in Maharashtra, Gujarat, Telangana and Karnataka; 15+ years',
        yearsExperience: 15,
        qualifications: [
            'B.E. Civil Engineering, PDA College of Engineering',
            'M.Tech Structural Engineering, R.V. College of Engineering, Bangalore',
            'Licensed Structural Design Engineer — Maharashtra',
            'Licensed Structural Design Engineer — Gujarat',
            'Licensed Structural Design Engineer — Telangana',
            'Licensed Structural Design Engineer — Karnataka',
        ],
        bio: [
            'Nakul Kabra is the Head of Structural Engineering at Vishwakalpa, with over 15 years of experience in structural design and construction across industrial, commercial, high-rise and residential projects, covering both RCC and steel structures.',
            'Nakul holds a Bachelor\'s degree in Civil Engineering from PDA College of Engineering and a Master of Technology in Structural Engineering from R.V. College of Engineering, Bangalore. He is a Licensed Structural Design Engineer in four states, Maharashtra, Gujarat, Telangana and Karnataka — a credential carrying formal government recognition of his competence to sign and certify structural designs independently.',
            'At Vishwakalpa, Nakul leads structural design across all industrial projects: PEB frame coordination and proof-checking, machine foundation design for heavy equipment including furnaces, cranes and CNC/VMC/HMC lines, crane runway beam design, and foundation engineering for complex industrial loads. His multi-state licensure and his experience bridging design and construction execution make him the firm\'s technical authority on everything that holds the building up.',
        ],
        photo: null,
        isLeadership: true,
        order: 4,
